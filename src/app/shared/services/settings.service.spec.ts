...
describe('SettingsService', () => {
    ...
    describe('#switchTheme', () => {
        ...
        it('should switch from dark to custom theme', () => {
            service.setTheme(Themes.dark);
            service.switchTheme();
            expect(service.selectedTheme).toEqual(Themes.custom);
        });
        it('should switch from custom to default theme', () => {
            service.setTheme(Themes.custom);
            service.switchTheme();
            expect(service.selectedTheme).toEqual(Themes.default);
        });
    });
